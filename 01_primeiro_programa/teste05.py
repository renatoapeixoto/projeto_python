...
''' 
Limitações:
Imutabilidade : O mapnão altera o iterável original, apenas retorna um novo 
iterador com os resultados.
Complexidade em funções : Quando as transformações são muito complexas, usar
 mappode dificultar a leitura do código. Neste caso, foros loops podem ser mais claros.
'''
